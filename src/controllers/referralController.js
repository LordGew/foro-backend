...
exports.seedRewards = async (req, res) => {
  try {
    ...
    const defaultRewards = [
      // EMOJIS
      { name: '🔥 Fuego', description: 'Emoji de fuego para mostrar tu pasión', type: 'emoji', cost: 50, content: '🔥', rarity: 'common', slug: 'fuego', iconUrl: `${twemojiBase}1f525.svg`, isActive: true },
      { name: '⚔️ Espadas Cruzadas', description: 'Muestra tu espíritu guerrero', type: 'emoji', cost: 75, content: '⚔️', rarity: 'common', slug: 'espadas-cruzadas', iconUrl: `${twemojiBase}2694.svg`, isActive: true },
      { name: '👑 Corona', description: 'Demuestra tu realeza', type: 'emoji', cost: 100, content: '👑', rarity: 'rare', slug: 'corona', iconUrl: `${twemojiBase}1f451.svg`, isActive: true },
      { name: '💎 Diamante', description: 'Brilla como un diamante', type: 'emoji', cost: 150, content: '💎', rarity: 'rare', slug: 'diamante', iconUrl: `${twemojiBase}1f48e.svg`, isActive: true },
      { name: '🌟 Estrella Brillante', description: 'Eres una estrella', type: 'emoji', cost: 200, content: '🌟', rarity: 'epic', slug: 'estrella-brillante', iconUrl: `${twemojiBase}1f31f.svg`, isActive: true },
      { name: '🐉 Dragón', description: 'El poder del dragón', type: 'emoji', cost: 300, content: '🐉', rarity: 'epic', slug: 'dragon', iconUrl: `${twemojiBase}1f409.svg`, isActive: true },
      { name: '🏆 Trofeo', description: 'Eres un campeón', type: 'emoji', cost: 500, content: '🏆', rarity: 'legendary', slug: 'trofeo', iconUrl: `${twemojiBase}1f3c6.svg`, isActive: true },
      
      // TÍTULOS
      { name: 'Novato', description: 'Apenas comienzas tu aventura', type: 'title', cost: 0, content: 'Novato', rarity: 'common', slug: 'novato', iconUrl: `${twemojiBase}1f195.svg`, isActive: true },
      { name: 'Aventurero', description: 'Has explorado muchos caminos', type: 'title', cost: 100, content: 'Aventurero', rarity: 'common', slug: 'aventurero', iconUrl: `${twemojiBase}1f5fa.svg`, isActive: true },
      { name: 'Cazador de Tesoros', description: 'Siempre buscando recompensas', type: 'title', cost: 150, content: 'Cazador de Tesoros', rarity: 'rare', slug: 'cazador-de-tesoros', iconUrl: `${twemojiBase}1f4a5.svg`, isActive: true },
      { name: 'Héroe de la Comunidad', description: 'Reconocido por todos', type: 'title', cost: 250, content: 'Héroe de la Comunidad', rarity: 'rare', slug: 'heroe-de-la-comunidad', iconUrl: `${twemojiBase}1f9b8.svg`, isActive: true },
      { name: 'Leyenda Viviente', description: 'Tu nombre será recordado', type: 'title', cost: 400, content: 'Leyenda Viviente', rarity: 'epic', slug: 'leyenda-viviente', iconUrl: `${twemojiBase}1f4af.svg`, isActive: true },
      { name: 'Maestro del Foro', description: 'Dominas todas las artes del foro', type: 'title', cost: 600, content: 'Maestro del Foro', rarity: 'epic', slug: 'maestro-del-foro', iconUrl: `${twemojiBase}1f9d0.svg`, isActive: true },
      { name: 'Dios de Azeroth', description: 'Has alcanzado la divinidad', type: 'title', cost: 1000, content: 'Dios de Azeroth', rarity: 'legendary', slug: 'dios-de-azeroth', iconUrl: `${twemojiBase}1f47f.svg`, isActive: true },
      
      // TEMAS
      { name: 'Tema Oscuro', description: 'Perfil con estilo oscuro elegante', type: 'theme', cost: 200, content: JSON.stringify({ background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)', textColor: '#e0e0e0', accentColor: '#8E2DE2' }), rarity: 'common', slug: 'tema-oscuro', iconUrl: `${twemojiBase}1f303.svg`, isActive: true },
      { name: 'Tema Fuego', description: 'Perfil con colores ardientes', type: 'theme', cost: 300, content: JSON.stringify({ background: 'linear-gradient(135deg, #ff4e50 0%, #f9d423 100%)', textColor: '#ffffff', accentColor: '#ff6b6b' }), rarity: 'rare', slug: 'tema-fuego', iconUrl: `${twemojiBase}1f525.svg`, isActive: true },
      { name: 'Tema Océano', description: 'Perfil con colores del mar', type: 'theme', cost: 300, content: JSON.stringify({ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', textColor: '#ffffff', accentColor: '#4facfe' }), rarity: 'rare', slug: 'tema-oceano', iconUrl: `${twemojiBase}1f30a.svg`, isActive: true },
      { name: 'Tema Naturaleza', description: 'Perfil con colores de la naturaleza', type: 'theme', cost: 400, content: JSON.stringify({ background: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)', textColor: '#ffffff', accentColor: '#06d6a0' }), rarity: 'epic', slug: 'tema-naturaleza', iconUrl: `${twemojiBase}1f33f.svg`, isActive: true },
      { name: 'Tema Arcoíris', description: 'Perfil con todos los colores', type: 'theme', cost: 800, content: JSON.stringify({ background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 25%, #feca57 50%, #48dbfb 75%, #ff9ff3 100%)', textColor: '#ffffff', accentColor: '#ee5a6f' }), rarity: 'legendary', slug: 'tema-arcoiris', iconUrl: `${twemojiBase}1f308.svg`, isActive: true },
      
      // MARCOS
      { name: 'Marco Básico', description: 'Un marco simple para tu foto', type: 'frame', cost: 100, content: JSON.stringify({ border: '3px solid #8E2DE2', borderRadius: '50%', boxShadow: '0 0 10px rgba(142, 45, 226, 0.5)' }), rarity: 'common', slug: 'marco-basico', iconUrl: `${twemojiBase}1f5bc.svg`, isActive: true },
      { name: 'Marco de Oro', description: 'Marco dorado brillante', type: 'frame', cost: 250, content: JSON.stringify({ border: '4px solid #FFD700', borderRadius: '50%', boxShadow: '0 0 15px rgba(255, 215, 0, 0.7)' }), rarity: 'rare', slug: 'marco-de-oro', iconUrl: `${twemojiBase}1f947.svg`, isActive: true },
      { name: 'Marco de Diamante', description: 'Marco con brillo de diamante', type: 'frame', cost: 400, content: JSON.stringify({ border: '5px solid #b9f2ff', borderRadius: '50%', boxShadow: '0 0 20px rgba(185, 242, 255, 0.8), 0 0 30px rgba(185, 242, 255, 0.5)' }), rarity: 'epic', slug: 'marco-de-diamante', iconUrl: `${twemojiBase}1f48e.svg`, isActive: true },
      { name: 'Marco Arcoíris', description: 'Marco con efecto arcoíris animado', type: 'frame', cost: 600, content: JSON.stringify({ border: '6px solid transparent', borderRadius: '50%', backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, #f093fb 0%, #f5576c 25%, #feca57 50%, #48dbfb 75%, #ff9ff3 100%)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 0 25px rgba(255, 105, 180, 0.8)' }), rarity: 'epic', slug: 'marco-arcoiris', iconUrl: `${twemojiBase}1f308.svg`, isActive: true },
      { name: 'Marco Legendario', description: 'El marco más exclusivo y poderoso', type: 'frame', cost: 1000, content: JSON.stringify({ border: '8px solid transparent', borderRadius: '50%', backgroundImage: 'linear-gradient(white, white), linear-gradient(45deg, #ff0000, #ff7300, #fffb00, #48ff00, #00ffd5, #002bff, #7a00ff, #ff00c8, #ff0000)', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 0 30px rgba(255, 0, 255, 1), 0 0 50px rgba(0, 255, 255, 0.8)' }), rarity: 'legendary', slug: 'marco-legendario', iconUrl: `${twemojiBase}1f31f.svg`, isActive: true }
    ];
